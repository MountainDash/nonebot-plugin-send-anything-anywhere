import DotMark from "@site/src/components/DotMark";
...
<Curtain>这完全是为了妥协腾讯 Open ID 的刁钻设计</Curtain>
...
- TargetQQGroup
- TargetQQPrivate
- <DotMark color="green">TargetQQGroupOpenId</DotMark>
- <DotMark color="green">TargetQQPrivateOpenId</DotMark>
...
小绿点标记的 PlatformTarget 是混入了 [BotSpecifier](#botspecifier) 的 PlatformTarget。
...
<Curtain>目前适配的 Adapter 中也只有它如此</Curtain>
